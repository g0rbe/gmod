...
import (
	...
	"github.com/g0rbe/gmod/cryptography/random"
)
...
func TestRandomString(t *testing.T) {
	...
	v := random.String([]byte("abcdefgh"), 10)
	if len(v) != 10 {
...
func BenchmarkRandomString(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		random.String([]byte("abcdefgh0"), 256)
	}
}
